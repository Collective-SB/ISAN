...
Given the positions of four transmitters, will calculated Axis constants necessary for positioning.

Most recent release: [V2.3b](Releases/InvEng%20V2.3b.yorel)
```c
goto 1+(:rst==1)
